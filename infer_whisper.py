...
from data_classes.whisper_dataset import TextProcessing
from data_classes.whisper_dataset import WhisperDataset
import os
...
def test(model: Any, test_loader: Any, processor: Any) :
...
if __name__ == "__main__":
    ...
    test_dataset = WhisperDataset(tf_dataset=ds, 
                                  ...
                                  model_language=config.inference.inference_language,
                                  model_task=config.inference.inference_task, 
                                  sampling_rate=config.inference.inference_sampling_rate)
    ...
    test(model, test_loader, processor)